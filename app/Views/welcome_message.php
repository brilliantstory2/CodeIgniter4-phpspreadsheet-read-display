...
<section>
    ...
    <form id="uploadForm">
        <div class="custom-import custom-button">
            <span class="label">Selece Excel File</span>
            <span class="label-file"></span>
            
            <input class="import-field" type="file" name="userfile" id='userfile'>
        </div>
    </form>
